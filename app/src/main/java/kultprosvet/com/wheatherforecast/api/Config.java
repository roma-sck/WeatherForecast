...
public class Config {
    ...
    public static final String LOCATION_DNIPRO_NAME = "Dnipropetrovsk";
    public static final String LOCATION_DNIPRO_LATITUDE = "48.45";
    public static final String LOCATION_DNIPRO_LONGITUDE = "34.98";
}
